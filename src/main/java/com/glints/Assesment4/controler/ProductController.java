...
import com.glints.Assesment4.service.ProductService;
...
public class ProductController {
	...
	public ResponseEntity<Product> create(@PathVariable("id") Integer id, @Valid @RequestBody ProductPayload productPayload){			
		Product product = productService.create(productPayload);
		return new ResponseEntity<Product>(product, HttpStatus.OK);
	}
